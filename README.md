...
Raw checkpoint data (`.h5`, `.vtu`) isn't included in this repo, it's regenerated by the command above. Available on request if you need the exact runs behind the figures without rerunning.
